...
class TestBuggyBehaviorPrevention:
    ...
    def test_alias_listing_includes_targets_for_restriction_validation(self):
        ...
        alias_only_snapshot = ["mini", "o4mini"]  # Missing 'gpt-5.4-mini', 'o4-mini' targets
        ...
        assert "o4mini" in comprehensive_list
    ...
    def test_target_models_are_recognized_during_validation(self):
        ...
        assert "gemini-pro" in all_known  # alias
    ...
    def test_policy_enforcement_remains_comprehensive(self):
        ...
        with patch.dict(os.environ, {"OPENAI_ALLOWED_MODELS": "gpt-5.4-mini,o4-mini"}):
            ...
            assert not provider.validate_model_name("gpt-5.4")  # Not in allowed list

            # "mini" now resolves to gpt-5.4-mini, which IS allowed
            assert provider.validate_model_name("mini")  # Resolves to gpt-5.4-mini, which IS allowed

            # o4mini (the actual alias for o4-mini) should also work
            ...
            assert "gpt-5.4-mini" in all_known  # Should be known (and allowed)
            assert "o4-mini" in all_known  # Should be known (and allowed)
            assert "gpt-5.4-pro" in all_known  # Should be known (but blocked)
            assert "mini" in all_known  # Should be known (and allowed since it resolves to gpt-5.4-mini)
    ...
    def test_alias_aware_listing_extends_canonical_view(self):
        ...
        for target in ("o4-mini", "gpt-5.4-mini"):
    ...
    def test_restriction_validation_uses_alias_aware_variant(self):
        ...
        def list_models_side_effect(**kwargs):
            ...
            if not respect_restrictions and include_aliases and lowercase and unique:
                return ["mini", "o4mini", "gpt-5.4-mini", "o4-mini"]
    ...
    def test_validation_correctly_identifies_invalid_models(self):
        ...
        with patch("utils.model_restrictions.logger") as mock_logger:
            ...
            assert "gpt-5.4-mini" in warning_text, "gpt-5.4-mini should appear in known models"
