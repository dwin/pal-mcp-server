...
class TestOpenRouterProvider:
    ...
    def test_model_alias_resolution(self):
        ...
        assert provider._resolve_model_name("o4mini") == "openai/o4-mini"
        ...
        assert provider._resolve_model_name("grok4.1") == "x-ai/grok-4.1-fast"
...
class TestOpenRouterAutoMode:
    ...
    def test_openrouter_with_restrictions(self):
        ...
        os.environ["OPENROUTER_ALLOWED_MODELS"] = "anthropic/claude-opus-4.1,google/gemini-3-flash-preview"
        os.environ["DEFAULT_MODEL"] = "auto"
        ...
        expected_allowed = {"google/gemini-3-flash-preview", "anthropic/claude-opus-4.1"}
...
class TestOpenRouterRegistry:
    ...
    def test_registry_capabilities(self):
        ...
        assert caps.context_window > 0  # Claude's context window (varies by version)
        ...
        # Test opus4.6 alias
        caps = registry.get_capabilities("opus4.6")
        assert caps is not None
        assert caps.model_name == "anthropic/claude-opus-4.6"
