...
class TestModelRestrictionService:
    ...
    def test_empty_string_allows_all(self):
        ...
        with patch.dict(os.environ, {"OPENAI_ALLOWED_MODELS": "", "GOOGLE_ALLOWED_MODELS": "flash"}):
            ...
            assert service.is_allowed(ProviderType.GOOGLE, "flash")
            assert service.is_allowed(ProviderType.GOOGLE, "gemini-3.5-flash", "flash")
...
class TestProviderIntegration:
    ...
    @patch.dict(os.environ, {"GOOGLE_ALLOWED_MODELS": "gemini-3.5-flash,flash"})
...
class TestRegistryIntegration:
    ...
    def test_registry_with_shorthand_restrictions(self):
        ...
        # recognize that "mini" allows "gpt-5.4-mini"
...
class TestShorthandRestrictions:
    ...
    @patch.dict(
        os.environ,
        {"OPENAI_ALLOWED_MODELS": "mini,o4-mini", "GOOGLE_ALLOWED_MODELS": "flash,gemini-3.5-flash"},
    )
    def test_both_shorthand_and_full_name_allowed(self):
        ...
        assert gemini_provider.validate_model_name("gemini-3.5-flash")
...
class TestAutoModeWithRestrictions:
    ...
    def test_fallback_with_shorthand_restrictions(self, monkeypatch):
        ...
        try:
            ...
            # "mini" is an alias for gpt-5.4-mini, but the list may show the alias itself.
            assert model in ["mini", "gpt-5.4-mini", "o4-mini", "gemini-3.5-flash"]
        finally:
